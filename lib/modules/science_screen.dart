  ...
  Widget build(BuildContext context) {
    return BlocConsumer<NewsCubit,NewsStates>( listener: (context,state){},
      builder: (context,state){
        ...
        return ConditionalBuilder(condition: c.scienceList.length>0,
          builder: (context){
            return ListView.separated(itemCount: c.scienceList.length,itemBuilder: (context,index){
              return buildNewsItem(c.scienceList[index],context);
